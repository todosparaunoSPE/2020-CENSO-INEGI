...
st.set_page_config(page_title="CENSO-2020-PEA-Aguascalientes", page_icon=":bar_chart:", layout="wide")
...
def get_data_from_excel():
    df = pd.read_excel(
        io="Aguascalientes.xlsx",
        engine="openpyxl",
        sheet_name="Aguascalientes",
        skiprows=3,
        usecols="B:Q",
        nrows=11,
    )
...
st.title(":bar_chart: Aguascalientes")
st.markdown("##")
